@extends('layouts.app')
@section('content')
<body style="background-color: maroon; color:whitesmoke;">
        ...
        <div>
            <form action="{{ route('add.to.cart') }}" method="post">
                ...
                <div style="height: 600px; background-color: rgb(230 219 219 / 15%); margin: 30px">
                    ...
                    <button type="submit" style="float:none; background-color: #68c368; border-radius: 10px; height: 35px; width: 200px; border: 2px solid #ffffff;" class="btn btn-danger btn-xs">Add To Cart</button>
                </div>
            </form>
        </div>
    </div>
